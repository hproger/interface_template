...
class EditorCalls extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      load_gain_name: this.props.load_gain_name
        ? this.props.load_gain_name
        : "", // name
      pool_from_name: this.props.pool_from_name
        ? this.props.pool_from_name
        : "", // name
    ...
    this.setState(
      (prevState) => {
        ...
        return {
          ...
          load_gain_name: nextProps.load_gain_name
            ? nextProps.load_gain_name
            : "",
          pool_from_name: nextProps.pool_from_name
            ? nextProps.pool_from_name
            : "",
          pool_to_name: nextProps.pool_to_name ? nextProps.pool_to_name : "",
          timeZone_UTC: nextProps.call
            ? nextProps.call.data.timeZone_UTC
            : prevState.timeZone_UTC
            ? prevState.timeZone_UTC
            : 0,
          prefix: nextProps.call
            ? nextProps.call.data.prefix
            : prevState.prefix
            ? prevState.prefix
            : "000",
          stopConditionRound: nextProps.call
            ? nextProps.call.data.stopConditionRound
            : prevState.stopConditionRound
            ? prevState.stopConditionRound
            : 1,
          stopConditionDate: nextProps.call
            ? nextProps.call.data.stopConditionDate
            : prevState.stopConditionDate
            ? prevState.stopConditionDate
            : moment().add(7, "days").format("YYYY-MM-DD"),
          stopConditionTime: nextProps.call
            ? nextProps.call.data.stopConditionTime
            : prevState.stopConditionTime
            ? prevState.stopConditionTime
            : moment(0, "HH").add(7, "days").format("HH:mm"),
          help_info_from: nextProps.help_info_from
            ? nextProps.help_info_from
            : 0,
          help_info_to: nextProps.help_info_to ? nextProps.help_info_to : 0,
          help_info_time_call: nextProps.help_info_time_call
            ? nextProps.help_info_time_call
            : 0,
  ...
  handleInputChange = (event, prsInt = false) => {
    ...
    value =
      prsInt && value
        ...
        : "";
    value =
      prsInt && value > 0 ? value : !prsInt && value ? value : !prsInt ? "" : 1;
    this.setState({
      [name]: value,
    });
  };
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              <div className="row">
                <div className="col-sm-4 col-md-4">
                  ...
                  <div className="form-group">
                    ...
                    <div className="input-group">
                      <input
                        ...
                        name="trunk_name"
                        readOnly={true}
                        value={this.state.trunk_name}
                      />
                      <span className="input-group-addon">
                        <span
                          className="glyphicon glyphicon-th-list select-btn"
                          data-toggle="modal"
                          href="#modal-trunks"
                          aria-hidden="true"
                          onClick={() => this.props.getListTrunks()}
                        ></span>
                      </span>
                    </div>
                  </div>
                  ...
                  <label>
                    {" "}
                    <h4>Остановить обзвон после</h4>{" "}
                  </label>
                  <div className="form-group">
                    <span>
                      <b>Количество кругов</b>
                    </span>
                    <input
                      type="text"
                      className="form-control"
                      maxLength="3"
                      name="stopConditionRound"
                      placeholder="2"
                      value={this.state.stopConditionRound}
                      onChange={(e) => this.handleInputChange(e, true)}
                    />
                  </div>
                  <div className="form-group">
                    ...
                    <input
                      type="date"
                      className="form-control"
                      name="stopConditionDate"
                      value={this.state.stopConditionDate}
                      onChange={(e) => this.handleInputChange(e)}
                    />
                    <input
                      type="time"
                      className="form-control"
                      name="stopConditionTime"
                      value={this.state.stopConditionTime}
                      onChange={(e) => this.handleInputChange(e)}
                    />
                  </div>
                </div>
                  ...
                  <div className="form-group">
                    ...
                    <div className="input-group">
                      <input
                        ...
                        name="load_gain"
                        readOnly={true}
                        value={this.state.load_gain_name}
                      />
                      <span className="input-group-addon">
                        <span
                          className="glyphicon glyphicon-th-list select-btn"
                          data-toggle="modal"
                          href="#modal-load_gain"
                          aria-hidden="true"
                          onClick={() => this.props.getListRate()}
                        ></span>
                      </span>
                    </div>
                  </div>
                  <div className="form-group">
                    ...
                    <div className="input-group">
                      <input
                        ...
                        name="pool_from_id"
                        readOnly={true}
                        value={this.state.pool_from_name}
                      />
                      <span className="input-group-addon">
                        <span
                          className="glyphicon glyphicon-th-list select-btn"
                          data-toggle="modal"
                          href="#modal-pool_from"
                          aria-hidden="true"
                          onClick={() => this.props.getListNumbers(true)}
                        ></span>
                      </span>
                    </div>
                  </div>
                    ...
                    <div className="input-group">
                      ...
                      <span className="input-group-addon">
                        <span
                          ...
                          href="#modal-pool_to"
                          aria-hidden="true"
                          onClick={() => this.props.getListNumbers()}
                        ></span>
                      </span>
                    </div>
                  </div>
                ...
                <div className="col-sm-4 col-md-4">
                  ...
                  <p>
                    ...
                    {Math.round(
                      this.state.help_info_to / this.state.help_info_time_call
                    )}{" "}
                  ...
                  <span>
                    ...
                    Звонков в час: <br /> мин - {this.state.minNumb}, макс -{" "}
                    {this.state.maxNumb}{" "}
                    <hr style={{ marginTop: "5px", marginBottom: "5px" }} />
                    Одновременных звонков: <br /> мин -{" "}
            ...
            <div className="modal-footer">
              <button
                ...
                data-dismiss={
                  this.state.name_call !== "" &&
                  this.state.trunk_name !== "" &&
                  this.state.load_gain_name !== "" &&
                  this.state.pool_from_name !== "" &&
                  this.state.pool_to_name !== "" &&
                  this.state.prefix !== "000" &&
                  "modal"
                }
                onClick={() => {
                  if (
