                ...
                <div className="row">
                  <div className="col-md-3">
                    <div className="category_block">
                      <NavLink to="/users" className="category_img">
                        <img src={_users} alt="Пользователи" />
                      </NavLink>
                  ...
                  <div className="col-md-3">
                    <div className="category_block">
                      <NavLink to="/rates" className="category_img">
                        <img src={_load} alt="Нагрузка" />
                      </NavLink>
                  ...
                  <div className="col-md-3">
                    <div className="category_block">
                      <NavLink to="/directions" className="category_img">
                        <img src={_directions} alt="Направления" />
                      </NavLink>
                  ...
                  <div className="col-md-3">
                    <div className="category_block">
                      <NavLink to="/numbers" className="category_img">
                        <img src={_numbers_pool} alt="Группы номеров" />
                      </NavLink>
            ...
            <div className="row">
              <div className="col-md-6">
                <div className="row">
                  <div className="col-md-3">
                    <div className="category_block">
                      <NavLink to="/backups" className="category_img">
                        <img src={_database} alt="Работа с БД" />
                      </NavLink>
                  ...
                  <div className="col-md-3">
                    <div className="category_block">
                      <NavLink to="/callers" className="category_img">
                        <img src={_schedule} alt="Обзвоны" />
                      </NavLink>
                  ...
                  <div className="col-md-3">
                    <div className="category_block">
                      <NavLink to="/system" className="category_img">
                        <img src={_system_monitor} alt="Состояние системы" />
                      </NavLink>
