...
class EditorRate extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      interfaceType:
        this.props.rateUser && this.props.rateUser.data.interfaceType
          ? this.props.rateUser.data.interfaceType
          : "simple", // активный интерфейс
  ...
  componentWillReceiveProps = (nextProps) => {
    ...
    const cmint = nextProps.rateUser
      ? this.calcMinMaxLoad(
          "call_min_time",
          nextProps.rateUser.data.Call_min_time
        )
      : 1;
    const cmaxt = nextProps.rateUser
      ? this.calcMinMaxLoad(
          "call_max_time",
          nextProps.rateUser.data.Call_max_time
        )
      : 1;
    ...
    this.setState(
      {
        dismiss: false,
        interfaceType:
          nextProps.rateUser && nextProps.rateUser.data.interfaceType
            ? nextProps.rateUser.data.interfaceType
            : "simple",
        titleRate: nextProps.rateUser ? nextProps.rateUser.name : "",
        load_gain: nextProps.rateUser ? nextProps.rateUser.data.LoadGain : 1,
        call_load: nextProps.rateUser
          ? nextProps.rateUser.data.Call_load
          : [
              [
                0,
                0,
        ...
        call_min_time: nextProps.rateUser
          ? nextProps.rateUser.data.Call_min_time
          : [
              [
                0,
        ...
        call_max_time: nextProps.rateUser
          ? nextProps.rateUser.data.Call_max_time
          : [
              [
                0,
        ...
        call_min: cmint,
        call_max: cmaxt,
        min_in_month: nextProps.rateUser
          ? this.calcMinMaxLoad(
              "call_load",
              nextProps.rateUser.data.Call_load,
              nextProps.rateUser.data.LoadGain
            )
          : 1,
        average_num: nextProps.rateUser
          ? this.calcAverNmb(
              nextProps.rateUser.data.Call_min_time,
              nextProps.rateUser.data.Call_max_time,
              cmint,
      ...
      () => {
        ...
        this.calcTempArraysCPH(
          this.state.average_call_time,
          this.state.call_load
        );
      }
    );
  ...
  handleInputMinMonth = (event) => {
    ...
    this.setState(
      ...
      this.calcAverNmb(
        this.state.call_min_time,
        this.state.call_max_time,
        this.state.call_min,
        this.state.call_max,
        this.state.call_load,
        true
  ...
  checkRequiredFields = () => {
    ...
    if (this.state.call_max < this.state.call_min) {
      alert(
  ...
  changeInputsCallTime = (event, arrName) => {
    ...
    const averNmb = this.calcAverNmb(
      this.state.call_min_time,
      this.state.call_max_time,
      this.state.call_min,
      this.state.call_max,
  ...
  calcTempArraysCPH = (act, call_load) => {
    ...
    this.setState(
      ...
      this.calcTempArraysSC(minNumb, maxNumb)
    ); // было this.calcTempArraysSC(tempArr,act)
  };
          ...
          <div className="modal-content">
              ...
              <div className="editor_rateUser">
                <form method="POST">
                  <div className="form-group row_inputs jcsb">
                    ...
                    <div className="item-col">
                      <select
                        ...
                        className="form-control"
                        onChange={this.handlerSelectInterface}
                  ...
                  <div
                    ...
                    style={{
                      display:
                        this.state.interfaceType === "extended" && "none",
                    }}
                  >
                    <div className="row_inputs">
                      <div className="item-col">
                        <label
                          htmlFor="min_in_month"
                        ...
                        <input
                          ...
                          name="min_in_month"
                          placeholder="300"
                          value={this.state.min_in_month}
                          onChange={this.handleInputMinMonth}
                        />{" "}
                        мин.
                      </div>
                    </div>
                    <div className="row_inputs">
                      <div className="item-col">
                        ...
                        <input
                          ...
                          name="call_min"
                          placeholder="25"
                          value={this.state.call_min}
                          onChange={this.handleInputCallMin}
                        />{" "}
                        сек.
                      </div>
                      <div className="item-col">
                        ...
                        <input
                          ...
                          name="call_max"
                          placeholder="300"
                          value={this.state.call_max}
                          onChange={this.handleInputCallMax}
                        />{" "}
                        сек.
                      </div>
                    </div>
                    <div className="output_data">
                      ...
                      <div className="table_odata">
                        <div className="uniform_load">
                          <div className="title_uload">
                            Нагрузка равномерная
                          </div>
                          <div className="day_uload">
                            В день {this.state.uniform_load_day} мин.
                          </div>
                          <div className="hour_uload">
                            В час {this.state.uniform_load_hour} мин.
                          </div>
                        </div>
                        <div className="incoming_call">
                          ...
                          <div className="average_icall">
                            <span>
                              Среднее время {this.state.incom_call} сек.
                            </span>
                          </div>
                        </div>
                      </div>
                  ...
                  <div
                    ...
                    style={{
                      display: this.state.interfaceType === "simple" && "none",
                    }}
                  >
                        ...
                        <div className="table-responsive grid-rate">
                          <h5>
                            ...
                            <input
                              ...
                              id="common_min_time"
                              className="form-control"
                              value={this.state.common_min_time}
                              onChange={(e) =>
                                this.setState({
                            ...
                            <button
                              ...
                              onClick={() =>
                                this.checkAllCells("call_min_time")
                              }
                            >
                              Задать всем
                            </button>
                        ...
                        <div className="table-responsive grid-rate">
                          <h5>
                            ...
                            <input
                              ...
                              id="common_max_time"
                              className="form-control"
                              value={this.state.common_max_time}
                              onChange={(e) =>
                                this.setState({
                            ...
                            <button
                              ...
                              onClick={() =>
                                this.checkAllCells("call_max_time")
                              }
                            >
                              Задать всем
                            </button>
                      ...
                      <div className="panel-heading">
                        <h3 className="panel-title">
                          ...
                          <input
                            ...
                            id="common_call_load"
                            className="form-control"
                            value={this.state.common_call_load}
                            onChange={(e) =>
                              this.setState({
                          ...
                          <button
                            ...
                            onClick={() => this.checkAllCells("call_load")}
                          >
                            Задать всем
                          </button>
                        </h3>
                        ...
                        <div className="row_inputs">
                          <div className="item-col">
                            ...
                            <input
                              ...
                              name="load_gain"
                              placeholder="1"
                              value={this.state.load_gain}
                              onChange={(event) =>
                                this.changeKo(parseInt(event.target.value))
                              }
                            />
                          </div>
                        </div>
                        <div className="info-text">
                          <div className="average-min">
                            ...
                            <div className="average-num">
                              {this.state.average_num}
                            </div>
                          </div>
                          <div className="call_in_day">
                            <div className="call_in_day-text">
                              Звонков в час:
                            </div>
                            <div className="call_in_day-num">
                              <div className="min-num">
                                MIN: {this.state.calls_per_hour_min}
                              </div>
                              <div className="max-num">
                                MAX: {this.state.calls_per_hour_max}
                              </div>
                            </div>
                          </div>
                          <div className="call_same_time">
                            ...
                            <div className="call_same_time-num">
                              <div className="min-num">
                                MIN: {this.state.simultaneous_calls_min}
                              </div>
                              <div className="max-num">
                                MAX: {this.state.simultaneous_calls_max}
                              </div>
                            </div>
                          </div>
                        </div>
            ...
            <div className="modal-footer">
              <button
                ...
                onClick={() => {
                  this.state.dismiss && this.saveRate();
                }}
              >
                Сохранить
              </button>{" "}
              {/*disabled={(this.state.call_max < this.state.call_min) && "disabled"}*/}
              <button
                type="button"
